...
function Marvelmind(adr, tty = "/dev/cu.usbmodem1411", baud = 9600, maxvaluescount = 3, debug = false, receiveUltrasoundPositionCallback = null, recieveUltrasoundRawDataCallback = null) {
    this.tty = tty;
    this.baud = baud;
    this.debug = debug;
